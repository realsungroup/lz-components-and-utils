...
export default class Editor extends React.Component<any,any> {
    ...
    componentDidMount() { 
        console.log('componentDidMount-->', this.editorRef, this.refs.editorElem, document.querySelector('#editor'))
    ...
    handleShowEditor = () => {
        ...
        editor.create()
            console.log('handleShowEditor-->', this.editorRef, this.editorRef.current,  this.refs.editorElem)
    ...
    render() {
        ...
        return (
            <Modal visible={isEditorShow} title="xxx邮件xxx">
                ...
                {/* <div ref={this.setEditorRef} style={{width: 800, height: 200}} id="editor" />  */}
                <div ref={this.editorRef} style={{width: 800, height: 200}} id="editor" /> 
